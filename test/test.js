...
tape( 'main export is a function', function test( t ) {
	...
	t.equal( typeof iterPow, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object (value+done; iterator, iterator)', function test( t ) {
	...
	values = [ 0.0, 0.5, 1.0 ];
	it = iterPow( createIterator( values ), randu() );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object (value+done; iterator, scalar)', function test( t ) {
	...
	values = [ 0.0, 0.5, 1.0 ];
	it = iterPow( createIterator( values ), 2.0 );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object (value+done; scalar, iterator)', function test( t ) {
	...
	values = [ 0.0, 0.5, 1.0 ];
	it = iterPow( 2.0, createIterator( values ) );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object which evaluates the exponential function for each iterated value (value+done; iterator, iterator)', function test( t ) {
	var expected;
	var actual;
	var it;
	var x;
	...
	it = iterPow( createIterator( x ), createIterator( y ) );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object which evaluates the exponential function for each iterated value (value+done; iterator, scalar)', function test( t ) {
	var expected;
	var actual;
	var it;
	var x;
	...
	it = iterPow( createIterator( x ), 2.0 );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object which evaluates the exponential function for each iterated value (value+done; scalar, iterator)', function test( t ) {
	var expected;
	var actual;
	var it;
	var y;
	...
	it = iterPow( 2.0, createIterator( y ) );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object which evaluates the exponential function for each iterated value (value+done; scalar, scalar)', function test( t ) {
	var expected;
	var actual;
	var it;
	var i;
